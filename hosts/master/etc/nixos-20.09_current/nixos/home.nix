...
let
  ...
  ## Neofetch
  neoconf = pkgs.fetchurl {
    url = "https://git.sr.ht/~dan4ik605743/dotfiles/blob/master/hosts/dan4ik/home/dan4ik/.config/neofetch/config.conf";
    sha256 = "0dxp0y24iz83wyygg7r2ha22nvw01fb7yp6yq7jicv0wfhmq5qv6";
  };
in
  { 
    nixpkgs.config = config.nixpkgs.config;
      xsession = {
        ...
        initExtra = ''
          ...
          ${pkgs.xorg.xmodmap}/bin/xmodmap -e "keycode 108 = space NoSymbol space"
          '';
        ...
        programs = {
            bash = {
              enable = true;
              bashrcExtra = ''
                PS1="\[\033[38;5;208m\]\u@\[$(tput sgr0)\]\[\033[38;5;166m\]\h:\[$(tput sgr0)\]\[\033[38;5;6m\]\w\[$(tput sgr0)\]> \[$(tput sgr0)\]"
                '';
              shellAliases = {
        ...
        home = {
          sessionVariables = {
            ...
            BROWSER = "qutebrowser";
            TERMINAL = "termite";
            XDG_DESKTOP_DIR = "/home/master/Downloads";
            XDG_DOWNLOAD_DIR = "/home/master/Downloads";
            XDG_PICTURES_DIR = "/home/master/Downloads";
        ...
        file = {
          ".config/neofetch/config.conf" = {
            text = builtins.readFile ''${neoconf}'';
        };
          ".config/nixpkgs/config.nix" = {
            text = ''{ allowUnfree = true; allowBroken = true; }'';
        };
          ".config/bpytop/bpytop.conf" = {
            text = builtins.readFile ./packages/config/bpytop.nix;
        };
      };
    };
}
