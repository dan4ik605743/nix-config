...
in
  {
    ...
    environment = {
      ...
      # apps
      pinta vlc transmission wpsoffice
      ...
      (pkgs.writeShellScriptBin "dotup" '' sudo cp -r /etc/nixos/* ~/dotfiles/etc/nixos/ && sudo cp -r ~/packages/* ~/dotfiles/home/dan4ik/packages/ && echo Finish! '')
    ];
  };
