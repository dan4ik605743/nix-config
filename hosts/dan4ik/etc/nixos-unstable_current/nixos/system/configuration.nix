...
let
  ...
  fontconf = pkgs.fetchurl {
    url = "https://git.sr.ht/~dan4ik605743/dotfiles/blob/master/hosts/dan4ik/home/dan4ik/.config/fontconfig/fonts.conf";
...
in
  {
    ...
    environment = {
      ...
      # apps
      pinta vlc wpsoffice google-chrome qbittorrent discord
      ...
      # scripts
      (pkgs.writeShellScriptBin "dotup" "doas cp -r /etc/nixos/* ~/dotfiles/hosts/dan4ik/etc/nixos-unstable_current/nixos/ && echo Finish!")
