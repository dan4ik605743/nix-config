...
in
{
  xsession = {
    ...
    windowManager.i3 = with colors; {
      ...
      config = rec {
        ...
        startup = [
          {
            command = "feh --bg-fill /home/dan4ik/.wallpapers/current.png";
            always = false;
            notification = false;
          }
  ...
  home = {
    ...
    file = {
      ...
      ".config/nixpkgs/config.nix" = {
        text = import ../users/dan4ik/config/nixpkgs.nix;
      };

      ".config/nvim/coc-settings.json" = {
        text = import ../users/dan4ik/config/neovim/coc-settings.nix;
      };

      ".config/nvim/init.vim" = {
        text = import ../users/dan4ik/config/neovim/neovim.nix { inherit pkgs; };
      };
  ...
  xresources.extraConfig = import ../users/dan4ik/config/xresources.nix { inherit colors; };
}
